...
set ModuleDirRelative=../IGLibSandbox
set CheckoutBranch=main
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.modules.IGLibSandbox.git
set RepositoryAddressSecondary=
set RepositoryAddressLocal=d:\backup_sync\bk_code\git\ig\misc\iglib_modules\IGLibSandbox\
set Remote=origin
set RemoteSecondary=
