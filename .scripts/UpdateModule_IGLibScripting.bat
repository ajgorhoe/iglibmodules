...
set ModuleDirRelative=../IGLibScripting
set CheckoutBranch=main
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.modules.IGLibScripting.git
set RepositoryAddressSecondary=
set RepositoryAddressLocal=d:\backup_sync\bk_code\git\ig\misc\iglib_modules\IGLibScripting\
set Remote=origin
set RemoteSecondary=
