...
# This is the script for cloning/updating the current container of container 
# repositories. Copy this script, .gitignore and UpdateOrCloneRepository.ps1
# to directory where you want to clone the current repo and use this script
...
Write-Host "`n`n======================================================="
Write-Host "Updating/cloning container of repository containers,"
Write-Host "  the \iglibmodules_Recursive..."
...
$global:CurrentRepo_Directory = "otherIG_Recursive/"
$global:CurrentRepo_Ref = "swrepos/RecursiveOtherIG/mainRecursiveOtherIG"
